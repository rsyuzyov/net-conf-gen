...
class ReportingTests(unittest.TestCase):
    def test_reporting_uses_scan_status_and_successful_auth_method(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            linux_servers_group_vars = Path(tmpdir, 'group_vars', 'linux_ssh.yml').read_text(encoding='utf-8')
            ...
            self.assertIn('linux_ssh:', inventory)
            ...
            self.assertIn('linux_ssh:', inventory_full)
